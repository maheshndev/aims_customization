      ...
      <table class="min-w-[1200px] table-auto text-xs border border-gray-300">
        <thead class="bg-gray-100 text-gray-700 uppercase">
          <tr>
            ...
            <th class="border px-2 py-1 whitespace-nowrap">Work Order Operation</th>
            ...
            <th class="border px-2 py-1 whitespace-nowrap">Machine Hr Capacity</th>
            <th class="border px-2 py-1 whitespace-nowrap">Loading Hrs</th>
            <th class="border px-2 py-1 whitespace-nowrap">Month Days</th>
            <th class="border px-2 py-1 whitespace-nowrap">Daily Capacity</th>
            <th class="border px-2 py-1 whitespace-nowrap">Utilization %</th>
            <th class="border px-2 py-1 whitespace-nowrap">Work Order Plan Date</th>
            <th class="border px-2 py-1 whitespace-nowrap">Sales Order Date</th>
          </tr>
        </thead>

        <tbody>
          <tr v-for="(r, index) in rows" :key="`${r.sales_order}-${r.item_code}-${r.machine}`"
