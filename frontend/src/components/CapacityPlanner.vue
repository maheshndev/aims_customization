			...
			<div class="bg-white rounded p-6 shadow-xl max-w-5xl w-full mx-4 space-y-4">
				...
				<div class="grid grid-cols-3 gap-4">
					...
					<div class="flex items-end">
						<button
							class="px-3 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200 w-full"
							@click="refreshData"
						>
							Refresh
						</button>
				...
				<div
					...
					class="mt-4 border rounded overflow-hidden max-h-80 overflow-y-auto"
				>
							...
							>
								...
								<td class="px-3 py-2 font-mono text-blue-600">
									...
									<span class="text-gray-500">{{
										row.available_start && row.available_start.split(" ")[1]
									}}</span>
								</td>
								<td
									class="px-3 py-2"
