			...
			<table class="table-auto min-w-[1400px] border-collapse w-full">
				<thead class="bg-gray-100 uppercase">
					<tr>
						...
						<th class="border px-3 py-2 whitespace-nowrap">Work Order ID</th>
						<th class="border px-3 py-2 whitespace-nowrap">Job Card ID</th>
						<th class="border px-3 py-2 whitespace-nowrap">Status</th>
						<th class="border px-3 py-2 whitespace-nowrap">Operations</th>
						<th class="border px-3 py-2 whitespace-nowrap">Workstations</th>
						...
						<th class="border px-3 py-2 whitespace-nowrap">Mould ID</th>
						...
						<th class="border px-3 py-2 whitespace-nowrap">BOM ID</th>
					</tr>
				</thead>
				<tbody>
					<tr
